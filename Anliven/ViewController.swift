...
class ViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    func captureOutput(_ output: AVCaptureOutput, didOutput sampleBuffer: CMSampleBuffer, from connection: AVCaptureConnection) {
        ...
        //        let templetImage:UIImage = #imageLiteral(resourceName: "circles")
        //
        //        DispatchQueue.main.async {
        //          let uiImage = self.imageFromSampleBuffer(sampleBuffer: sampleBuffer)
        //
        //            if let nummber = OpneCVWrapper.matchTemplate(templetImage, in: uiImage ){
        //                self.faceImageView.image = nummber
        //            }
        //         }
    ...
    @IBAction private func userTapped(_ sender: UITapGestureRecognizer) {
        ...
        self.highlightView?.frame.size = CGSize(width: 120, height: 160)
        self.faceImageView.frame.size = CGSize(width: 120, height: 80)
        
        self.highlightView?.center = sender.location(in: self.view)
        self.faceImageView.image = #imageLiteral(resourceName: "face")
    ...
    //convert CMSampleBufferImage to UIImage
